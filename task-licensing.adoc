...
NetApp에서 구매한 Cloud Sync 라이센스를 연장한 경우, 새 만료 날짜는 Cloud Sync에서 자동으로 업데이트되지 않습니다. 만료 날짜를 새로 고치려면 라이센스를 다시 추가해야 합니다. 라이센스는 Cloud Sync 또는 해당 웹 사이트를 통해 관리해야 하며 * 디지털 지갑을 통해 관리해서는 안 됩니다.
