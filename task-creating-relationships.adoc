...
+
--
이 설정은 동기화 관계를 생성하고 S3 버킷 또는 Google Cloud Storage의 데이터를 Azure Blob 스토리지, CIFS, Google Cloud Storage, IBM Cloud Object Storage, NFS, S3 및 StorageGRID의 대상으로 동기화할 때만 사용할 수 있습니다.
