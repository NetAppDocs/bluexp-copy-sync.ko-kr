...
로그인, 계정 설정, Connector 구축 및 작업 환경 생성이 포함된 Cloud Manager를 시작해야 합니다.
...
[role="quick-margin-para"]
Cloud Volumes ONTAP 및 온프레미스 ONTAP 클러스터에는 커넥터가 필요합니다.

* https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-overview.html["Cloud Manager를 시작하는 방법을 알아보십시오"^]
